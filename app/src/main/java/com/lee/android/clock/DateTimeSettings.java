...
import com.phicomm.library.datetimepicker.time.RadialPickerLayout;
import com.phicomm.library.datetimepicker.time.TimePickerDialog;
...
import com.phicomm.library.datetimepicker.date.DatePickerDialog;

public class DateTimeSettings extends SettingsPreferenceFragment
        implements OnSharedPreferenceChangeListener,
                TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, Indexable {

    private static final String HOURS_12 = "12";
    private static final String HOURS_24 = "24";
    public static final String FRAG_TAG_TIME_PICKER = "time_dialog";
    public static final String FRAG_TAG_DATE_PICKER = "date_dialog";
    ...
    private void initUI() {
        ...
        for (int i = 0; i < formattedDates.length; i++) {
            String formatted =
                    ...
                    DateFormat.getLongDateFormat(getActivity()).format(mDummyDate.getTime());
        ...
        //modify by niexu for BUG ELL-18 
        ...
        // Begin: jili.fang for PL-1479 at 2015-10-21
        String curDateformat = Settings.System.getString(getContentResolver(), Settings.System.DATE_FORMAT);
        mDateFormat.setValue(curDateformat);
        // End: jili.fang for PL-1479 at 2015-10-21
    }
    ...
    public void onResume() {
        ...
        postHighlightPreferenceIfNeeded();// Yuzhou.Zhang for PL-7362 at 2015-11-23
    }
    ...
    public void updateTimeAndDateDisplay(Context context) {
        ...
        //modify by niexu for BUG ELL-18 begin
        String dateformat = Settings.System.getString(context.getContentResolver(),
                Settings.System.DATE_FORMAT);
        // Begin: jili.fang for PL-3083, PL-5666 and PL-5669 at 2015-10-21
        // if (dateformat != null && !dateformat.equals("")) {
        // mDateFormat.setSummary(dateformat);
        // } else {
        // mDateFormat.setSummary(R.string.default_date_format);
        // }

        CharSequence[] dateFormats = mDateFormat.getEntryValues();
        CharSequence[] formattedDates = mDateFormat.getEntries();

        for (int i = 0; i < dateFormats.length; i++) {
            if (dateFormats[i].equals(dateformat)) {
                mDateFormat.setSummary(formattedDates[i]);
            }
        }
        // End: jili.fang for PL-3083, PL-5666 and PL-5669 at 2015-10-21
...
/*
   ...
   //Begin: xu.nie for OS 5.0 at 2015-6-20
    private void creatAndTranTimePickerDialog(){
        final Calendar calendar = Calendar.getInstance();
    ...
    private void createAndTranDatePicker(){
        final Calendar calendar = Calendar.getInstance();
        DatePickerDialog dialog = DatePickerDialog.newInstance(this, calendar.get(Calendar.YEAR),
                calendar.get(Calendar.MONTH),
                calendar.get(Calendar.DAY_OF_MONTH));
        FragmentManager manager = getChildFragmentManager();
        manager.executePendingTransactions();
        final FragmentTransaction ft = manager.beginTransaction();
        final Fragment prev = manager.findFragmentByTag(FRAG_TAG_DATE_PICKER);
        if (prev != null) {
            ft.remove(prev);
        }
        ft.commit();
        ...
        if (dialog != null && !dialog.isAdded()) {
            dialog.show(manager, FRAG_TAG_DATE_PICKER);
        }
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mDatePref) {
            ...
            createAndTranDatePicker();
        } else if (preference == mTimePref) {
            // The 24-hour mode may have changed, so recreate the dialog
            //removeDialog(DIALOG_TIMEPICKER);
            //showDialog(DIALOG_TIMEPICKER);
            creatAndTranTimePickerDialog();
    ...
    //End: xu.nie for OS 5.0 at 2015-6-20
    @Override
  ...
  //End: xu.nie for OS 5.0 at 2015-6-20
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            rt.add("auto_time_zone_category");
            rt.add("manual_time_zone_category");
            return rt;
        }
    };
}
